...
import core.rsolano.liqinterface.view.backing.Login;
...
public class JSFUtils {
    ...
    */
    ...
    public static boolean LoggedActive(){
        Login logged = (Login)JSFUtils.getManagedBeanValue("sessionScope.login");
