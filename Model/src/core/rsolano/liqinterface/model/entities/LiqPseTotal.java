...
@Entity
@NamedQueries({ @NamedQuery(name = "LiqPseTotal.findAll", query = "select o from LiqPseTotal o") })
@Table(name = "LIQ_PSE_TOTAL")
public class LiqPseTotal implements Serializable {
    ...
    public LiqPseTotal(String autorizador, Long basetarifa, String ceoi, String cus, String descripcionestado,
