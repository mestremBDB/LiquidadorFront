...
@Entity
@NamedQueries({ @NamedQuery(name = "TempTemppse.findAll", query = "select o from TempTemppse o") })
@Table(name = "TEMP_TEMPPSE")
public class TempTemppse implements Serializable {
    private static final long serialVersionUID = -9083325953348341656L;
    ...
    public TempTemppse(String autorizacion, Long basetarifa, Integer ciclo, Long clientepope, String cus,
                       String empresa, String entidadautorizadora, String entidadrecaudadora, Date fecha, Long iva,
                       Long neto, String nit, String tarifaaplicada, Long tarifacobradabr, Long tarifacobradaefr,
